...
function ParentPal() {
  return (
    <ProjectTemplate
      ...
      embeddedUrl="https://embed.figma.com/proto/THitc9AYOHw87f33xD0Dhk/Capstone-Project?node-id=48-4&p=f&scaling=scale-down&content-scaling=fixed&page-id=48%3A2&starting-point-node-id=48%3A4&embed-host=share"
